...
#define ExtensionName "Output Max Species Age"
...
AppId={{F72E99A5-DB3F-4F80-B5AE-785235DC7050}
...
Source: {#BuildDir}\Landis.Extension.Output.MaxSpeciesAge-v3.dll; DestDir: {#ExtDir}; Flags: replacesameversion
...
#define InfoTxt "Output MaxSpeciesAge 3.0.txt"
Source: {#InfoTxt}; DestDir: {#LandisPlugInDir}
; NOTE: Don't use "Flags: ignoreversion" on any shared system files


[Run]
Filename: {#ExtensionsCmd}; Parameters: "remove ""Output Max Species Age"" "; WorkingDir: {#LandisPlugInDir}
